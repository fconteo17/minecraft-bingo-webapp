      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        >
          <div className="flex justify-between items-center">
            <h3 className="font-medium text-gray-100">{teams[0]}</h3>
            <p className={`text-sm ${winner === teams[0] ? 'text-emerald-300' : 'text-gray-300'}`}>
              {team1Quests} Quests
            </p>
          </div>
        </div>
        ...
        >
          <div className="flex justify-between items-center">
            <h3 className="font-medium text-gray-100">{teams[1]}</h3>
            <p className={`text-sm ${winner === teams[1] ? 'text-emerald-300' : 'text-gray-300'}`}>
              {team2Quests} Quests
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 gap-2">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
          {players.map((player) => {
            ...
            return (
              <div key={player} className={`p-2 rounded-lg border ${color.bg} ${color.border}`}>
                <div className="flex justify-between items-center">
    ...
    <div className="bg-gray-800 rounded-lg shadow-lg border border-gray-700 p-4 mb-4">
      <div className="flex justify-between items-center mb-2">
        <div className="flex items-center gap-4">
          <h2 className="text-lg font-bold text-gray-100">#{id.slice(0, 8)}</h2>
