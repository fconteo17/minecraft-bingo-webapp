    ...
    <div className="api-docs-container p-4 max-w-6xl mx-auto pb-20">
      <div className="bg-gradient-to-r from-blue-900/30 to-indigo-900/30 p-6 rounded-lg border border-blue-800 mb-8">
        ...
        <p className="text-gray-300 mb-3">
          Complete API reference for integrating with the Minecraft Bingo game system. Supports both
          team-based and free-for-all (solo) game modes.
        </p>
        <div className="flex flex-wrap gap-4 mt-4">
          <div className="bg-blue-900/40 px-4 py-2 rounded-md border border-blue-700">
            ...
            <span className="font-mono text-white">
              https://minecraft-bingo-webapp.vercel.app/api
            </span>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-gray-800 p-4 rounded-lg border border-gray-700">
          ...
          <p className="text-gray-300 mb-2">
            Create games with two competing teams (Red vs Blue) where players work together to
            complete quests.
          </p>
          <div className="text-gray-400 text-sm">
            <code className="bg-gray-900 text-blue-300 p-1 rounded">
              gameType: &quot;Teams&quot;
            </code>
          </div>
        </div>
        ...
        <div className="bg-gray-800 p-4 rounded-lg border border-gray-700">
          ...
          <div className="text-gray-400 text-sm">
            <code className="bg-gray-900 text-purple-300 p-1 rounded">
              gameType: &quot;Solo&quot;
            </code>
          </div>
        </div>
      ...
      <div className="bg-gray-800 p-4 rounded-lg mb-8">
        ...
        <div className="space-y-2 text-gray-300">
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li>
              Expand any endpoint to see details about request parameters and response formats
            </li>
            <li>
              Use the &quot;Try it out&quot; button to test API calls directly from the browser
            </li>
