  ...
  return (
    <main className="container mx-auto px-4 py-8 pb-20">
      <div className="prose prose-invert max-w-none">
        <h1 className="text-4xl font-bold text-center mb-8">Minecraft Bingo Plugin - Official Wiki</h1>
        
        <div className="bg-gray-800 p-4 rounded-lg mb-8">
          <p className="text-center">
            This wiki provides documentation for the Minecraft Bingo plugin - a lockout minigame with specialized kits.
          </p>
        ...
        <div className="space-y-2 bg-gray-800 p-4 rounded-lg mb-8">
          ...
          <ul className="space-y-1">
            <li><a href="#what-is-bingo" className="text-blue-400 hover:text-blue-300">What is Bingo?</a></li>
            <li><a href="#how-to-play" className="text-blue-400 hover:text-blue-300">How to Play</a></li>
            <li><a href="#kits-overview" className="text-blue-400 hover:text-blue-300">Kits Overview</a></li>
            <li><a href="#available-kits" className="text-blue-400 hover:text-blue-300">Available Kits</a></li>
            <li><a href="#feasts" className="text-blue-400 hover:text-blue-300">Feasts and Mini-Feasts</a></li>
            <li><a href="#game-modes" className="text-blue-400 hover:text-blue-300">Game Modes</a></li>
            <li><a href="#commands" className="text-blue-400 hover:text-blue-300">Plugin Commands</a></li>
            <li><a href="#tips" className="text-blue-400 hover:text-blue-300">Tips for Success</a></li>
            <li><a href="#additional-info" className="text-blue-400 hover:text-blue-300">Additional Information</a></li>
          </ul>
        </div>
        ...
        <section id="what-is-bingo">
          ...
          {(activeSection === 'what-is-bingo' || activeSection === null) && (
            <div className="mt-4">
              <p>
                Bingo is a lockout minigame with kits where players compete to complete tasks (quests) on a Minecraft bingo card. 
                Each kit contains unique items and special abilities that get enhanced throughout the game.
              </p>
              <p className="mt-2">Match formats:</p>
              <ul className="list-disc pl-6 mt-2">
                <li><strong>Team Mode</strong>: Two teams (Red vs Blue) compete to complete tasks first</li>
                <li><strong>Solo Mode</strong>: Multiple players in a free-for-all format</li>
                <li><strong>Kit vs Non-Kit</strong>: Choose whether to enable special kits or play vanilla</li>
                <li><strong>Ranked vs Casual</strong>: For team matches, choose between casual or ranked matches</li>
              </ul>
            </div>
          )}
        </section>
          ...
          {(activeSection === 'how-to-play' || activeSection === null) && (
            <div className="mt-4">
              <ol className="list-decimal pl-6">
                ...
                <li>Win conditions:
                  <ul className="list-disc pl-6 mt-2">
                    <li><strong>Team Mode</strong>: First team to complete 13 tasks wins</li>
                    <li><strong>Solo Mode</strong>: Game ends when all tasks are completed; player with most points wins</li>
                  </ul>
                </li>
                <li>Throughout the game, 3 mini feasts and 1 feast spawn at random map coordinates, providing useful loot</li>
        ...
        <section id="kits-overview">
          ...
          {(activeSection === 'kits-overview' || activeSection === null) && (
            <div className="mt-4">
              <p>
                Each kit provides unique abilities, items, and play styles. Kits receive buffs throughout the game, 
                particularly after completing tasks.
              </p>
              <h3 className="text-xl font-semibold mt-4">Kit System Mechanics</h3>
              <ul className="list-disc pl-6 mt-2">
                <li><strong>Start Kit</strong>: Initial items and abilities given when the game starts</li>
                <li><strong>Complete Kit</strong>: Enhanced abilities and items given after completing tasks</li>
                <li><strong>Respawn</strong>: Kits are re-applied when a player respawns</li>
              </ul>
            </div>
          )}
        </section>
        ...
        <section id="available-kits">
          ...
          {activeSection !== 'available-kits' && (
            <div className="mt-4">
              <p>Click to view details on all 20 available kits including Hunter, Aquaman, Miner, Survivor, Beastmaster, and more.</p>
            </div>
          )}
        </section>
        ...
        <section id="game-modes">
          ...
          {(activeSection === 'game-modes' || activeSection === null) && (
            <div className="mt-4">
              ...
              <ul className="list-disc pl-6 mt-2">
                <li><strong>Ranked</strong>: Affects player rankings and stats</li>
                <li><strong>Casual</strong>: Practice mode with no ranking impact</li>
              </ul>
            </div>
          )}
        </section>
            ...
            <div className="mt-4">
              <div className="bg-gray-800 p-4 rounded-lg overflow-x-auto">
                <table className="min-w-full">
                  ...
                  <tbody>
                    <tr>
                      <td className="py-2 px-4 border-b border-gray-700"><code>/bingo</code></td>
                      <td className="py-2 px-4 border-b border-gray-700">Main plugin command</td>
                    </tr>
                    <tr>
                      <td className="py-2 px-4 border-b border-gray-700"><code>/menu</code></td>
                      <td className="py-2 px-4 border-b border-gray-700">Open the kit selection menu</td>
                    </tr>
                    <tr>
                      <td className="py-2 px-4 border-b border-gray-700"><code>/tc &lt;message&gt;</code></td>
                      <td className="py-2 px-4 border-b border-gray-700">Team chat (Team Mode only)</td>
                    </tr>
                    <tr>
                      <td className="py-2 px-4 border-b border-gray-700"><code>/ff</code></td>
                      <td className="py-2 px-4 border-b border-gray-700">Forfeit the current match</td>
                    </tr>
                    <tr>
                      <td className="py-2 px-4 border-b border-gray-700"><code>/profile</code></td>
                      <td className="py-2 px-4 border-b border-gray-700">View your player profile and stats</td>
                    </tr>
                  </tbody>
                </table>
              </div>
        ...
        <section id="tips">
          ...
          {(activeSection === 'tips' || activeSection === null) && (
            <div className="mt-4">
              <ol className="list-decimal pl-6">
                <li><strong>Choose the right kit</strong> for your playstyle and the match type</li>
                <li><strong>Coordinate with teammates</strong> in Team Mode</li>
                <li><strong>Track feast timers</strong> to gain advantage from loot</li>
                <li><strong>Focus on your kit&apos;s strengths</strong> for task completion</li>
                <li><strong>Prioritize high-value tasks</strong> that align with your kit abilities</li>
                <li><strong>Keep an eye on enemy progress</strong> to block key tasks</li>
              </ol>
            </div>
          )}
        </section>
            ...
            <div className="mt-4">
              ...
              <div className="mt-6 border-t border-gray-700 pt-4">
                <p className="text-center text-gray-400">
                  This Wiki page provides an overview of the Minecraft Bingo plugin and its features. 
                  For more detailed information or specific questions, please contact the server administrators.
                </p>
              </div>
            </div>
          )}
